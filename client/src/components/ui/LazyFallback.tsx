...
export const LazyErrorBoundary: Component<ParentProps<{ name?: string; fallback?: JSX.Element }>> = (props) => (
  <ErrorBoundary
    fallback={(err, reset) => {
      console.error(`[LazyLoad] Failed to load "${props.name ?? "component"}":`, err);
